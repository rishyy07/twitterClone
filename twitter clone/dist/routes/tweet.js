...
router.post("/tweet", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield prisma.tweet.create({
        data: {
            title, content,
            user: {
...
router.get("/tweet", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userTweet = yield prisma.tweet.findMany({
        include: {
            user: true
        }
    });
...
router.get("/tweet/:tweetid", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userTweet = yield prisma.tweet.findUnique({
        where: {
            id: tweetId
        },
        include: {
...
router.delete("/tweet/:tweetid", auth_1.verifyToken, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const TweetExist = yield prisma.tweet.findUnique({
        where: {
            id: tweetId
        }
    });
